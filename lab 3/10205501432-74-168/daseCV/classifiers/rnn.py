...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            ...
            h, cache_rnn = lstm_forward(word_vectors, h0, Wx, Wh, b)
    ...
    def sample(self, features, max_length=30):
        ...
        for t in range(1, max_length):
            word_vectors, _ = word_embedding_forward(captions[:, t - 1:t], W_embed)
            if self.cell_type == 'rnn':
                h, _ = rnn_step_forward(word_vectors[:, 0, :], h, Wx, Wh, b)
            elif self.cell_type == 'lstm':
                h, c, _ = lstm_step_forward(word_vectors[:, 0, :], h, c, Wx, Wh, b)
